...
<div class="container py-4">
    <h1 class="mb-4 text-primary fw-bold">🧾 Solicitudes de mantenimiento asignadas</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('solicitudes.updateEstado', $req['id']) }}"
                                    ...
                                    {{-- Razón de rechazo (solo visible si se elige Rechazado) --}}
...
{{-- Mostrar/ocultar razón de rechazo --}}
@push('scripts')
<script>
